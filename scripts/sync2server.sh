...
# Sync files
rsync -avz -e "ssh $SSH_OPTS" --exclude '.git' --exclude '__pycache__' --exclude '*.pyc' --exclude '.DS_Store' /Users/tianyu/Work/PipelineRL/ tyhua@node${NODE}-ccn2cluster.stanford.edu:/ccn2/u/tyhua/PipelineRL/
